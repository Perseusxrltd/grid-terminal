...
declare_id!("veGRIDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
...
pub mod vegrid_staking {
    ...
    pub fn withdraw(ctx: Context<Withdraw>) -> Result<()> {
        ...
        anchor_spl::token::transfer(transfer_ctx, lock.amount)?;
...
pub struct Withdraw<'info> {
    ...
    #[account(mut)]
    pub lock_token_account: Account<'info, TokenAccount>, // Vault

    #[account(mut)]
    pub owner_token_account: Account<'info, TokenAccount>, // User
